...
( define basic-tile2 ( overlay/offset ( pip ) d d ( overlay/offset ( pip ) nd nd blank-tile ) ) )
...
( define basic-tile6 ( overlay/offset ( pip ) 0 d ( overlay/offset ( pip ) 0 nd basic-tile4 ) ) )
;-------------------------------------------------------------------------------
